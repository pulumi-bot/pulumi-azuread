...
def get_application(application_id: Optional[str] = None, name: Optional[str] = None, oauth2_permissions: Optional[List[pulumi.InputType['GetApplicationOauth2PermissionArgs']]] = None, object_id: Optional[str] = None, optional_claims: Optional[pulumi.InputType['GetApplicationOptionalClaimsArgs']] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApplicationResult:
    """
