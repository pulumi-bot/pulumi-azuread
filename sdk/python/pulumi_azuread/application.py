...
class Application(pulumi.CustomResource):
    app_roles: pulumi.Output[Optional[List['outputs.ApplicationAppRole']]] = pulumi.property("appRoles")
    """
    ...
    available_to_other_tenants: pulumi.Output[Optional[bool]] = pulumi.property("availableToOtherTenants")
    """
    Is this Azure AD Application available to other tenants? Defaults to `false`.
    """

    group_membership_claims: pulumi.Output[Optional[str]] = pulumi.property("groupMembershipClaims")
    """
    ...
    homepage: pulumi.Output[str] = pulumi.property("homepage")
    """
    The URL to the application's home page. If no homepage is specified this defaults to `https://{name}`.
    """

    identifier_uris: pulumi.Output[List[str]] = pulumi.property("identifierUris")
    """
    A list of user-defined URI(s) that uniquely identify a Web application within it's Azure AD tenant, or within a verified custom domain if the application is multi-tenant.
    """

    logout_url: pulumi.Output[Optional[str]] = pulumi.property("logoutUrl")
    """
    ...
    oauth2_allow_implicit_flow: pulumi.Output[Optional[bool]] = pulumi.property("oauth2AllowImplicitFlow")
    """
    Does this Azure AD Application allow OAuth2.0 implicit flow tokens? Defaults to `false`.
    """

    oauth2_permissions: pulumi.Output[List['outputs.ApplicationOauth2Permission']] = pulumi.property("oauth2Permissions")
    """
    ...
    optional_claims: pulumi.Output[Optional['outputs.ApplicationOptionalClaims']] = pulumi.property("optionalClaims")
    """
    ...
    owners: pulumi.Output[List[str]] = pulumi.property("owners")
    """
    ...
    prevent_duplicate_names: pulumi.Output[Optional[bool]] = pulumi.property("preventDuplicateNames")
    """
    If `true`, will return an error when an existing Application is found with the same name. Defaults to `false`.
    """

    public_client: pulumi.Output[bool] = pulumi.property("publicClient")
    """
    Is this Azure AD Application a public client? Defaults to `false`.
    """

    reply_urls: pulumi.Output[List[str]] = pulumi.property("replyUrls")
    """
    A list of URLs that user tokens are sent to for sign in, or the redirect URIs that OAuth 2.0 authorization codes and access tokens are sent to.
    """

    required_resource_accesses: pulumi.Output[Optional[List['outputs.ApplicationRequiredResourceAccess']]] = pulumi.property("requiredResourceAccesses")
    """
