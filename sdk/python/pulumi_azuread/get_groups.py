...
class GetGroupsResult:
    ...
    def __init__(__self__, id=None, names=None, object_ids=None) -> None:
...
def get_groups(names: Optional[List[str]] = None, object_ids: Optional[List[str]] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGroupsResult:
    """
