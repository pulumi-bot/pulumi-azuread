...
class ServicePrincipal(pulumi.CustomResource):
    app_role_assignment_required: pulumi.Output[Optional[bool]] = pulumi.output_property("appRoleAssignmentRequired")
    """
    ...
    """
    oauth2_permissions: pulumi.Output[List['outputs.ServicePrincipalOauth2Permission']] = pulumi.output_property("oauth2Permissions")
    """
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, app_role_assignment_required: Optional[pulumi.Input[bool]] = None, application_id: Optional[pulumi.Input[str]] = None, oauth2_permissions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServicePrincipalOauth2PermissionArgs']]]]] = None, tags: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, app_role_assignment_required: Optional[pulumi.Input[bool]] = None, application_id: Optional[pulumi.Input[str]] = None, display_name: Optional[pulumi.Input[str]] = None, oauth2_permissions: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['ServicePrincipalOauth2PermissionArgs']]]]] = None, object_id: Optional[pulumi.Input[str]] = None, tags: Optional[pulumi.Input[List[pulumi.Input[str]]]] = None) -> 'ServicePrincipal':
        """
