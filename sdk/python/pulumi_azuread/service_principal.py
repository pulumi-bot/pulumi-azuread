...
class ServicePrincipal(pulumi.CustomResource):
    app_role_assignment_required: pulumi.Output[Optional[bool]] = pulumi.property("appRoleAssignmentRequired")
    """
    ...
    oauth2_permissions: pulumi.Output[List['outputs.ServicePrincipalOauth2Permission']] = pulumi.property("oauth2Permissions")
    """
