...
class ApplicationAppRoleArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "allowedMemberTypes", allowed_member_types)
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "displayName", display_name)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "isEnabled", is_enabled)
...
class ApplicationOauth2PermissionArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "adminConsentDescription", admin_consent_description)
        pulumi.set(__self__, "adminConsentDisplayName", admin_consent_display_name)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "isEnabled", is_enabled)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "userConsentDescription", user_consent_description)
        pulumi.set(__self__, "userConsentDisplayName", user_consent_display_name)
        pulumi.set(__self__, "value", value)
...
class ApplicationOptionalClaimsArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "accessTokens", access_tokens)
        pulumi.set(__self__, "idTokens", id_tokens)
...
class ApplicationOptionalClaimsAccessTokenArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "additionalProperties", additional_properties)
...
class ApplicationRequiredResourceAccessArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "resourceAccesses", resource_accesses)
        pulumi.set(__self__, "resourceAppId", resource_app_id)
