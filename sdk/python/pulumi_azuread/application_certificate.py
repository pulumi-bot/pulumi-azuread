...
class ApplicationCertificate(pulumi.CustomResource):
    application_object_id: pulumi.Output[str] = pulumi.property("applicationObjectId")
    """
    ...
    end_date: pulumi.Output[str] = pulumi.property("endDate")
    """
    ...
    end_date_relative: pulumi.Output[Optional[str]] = pulumi.property("endDateRelative")
    """
    ...
    start_date: pulumi.Output[str] = pulumi.property("startDate")
    """
