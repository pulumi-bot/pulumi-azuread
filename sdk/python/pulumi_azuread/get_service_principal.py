...
@pulumi.output_type
class _GetServicePrincipalResult(dict):
    app_roles: List['outputs.GetServicePrincipalAppRoleResult'] = pulumi.property("appRoles")
    application_id: str = pulumi.property("applicationId")
    display_name: str = pulumi.property("displayName")
    id: str = pulumi.property("id")
    oauth2_permissions: List['outputs.GetServicePrincipalOauth2PermissionResult'] = pulumi.property("oauth2Permissions")
...
def get_service_principal(application_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azuread:index/getServicePrincipal:getServicePrincipal', __args__, opts=opts, typ=_GetServicePrincipalResult).value
