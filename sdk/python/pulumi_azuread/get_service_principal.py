...
class GetServicePrincipalResult:
    ...
    def __init__(__self__, app_roles=None, application_id=None, display_name=None, id=None, oauth2_permissions=None, object_id=None) -> None:
...
def get_service_principal(application_id: Optional[str] = None, display_name: Optional[str] = None, oauth2_permissions: Optional[List[pulumi.InputType['GetServicePrincipalOauth2PermissionArgs']]] = None, object_id: Optional[str] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServicePrincipalResult:
    """
