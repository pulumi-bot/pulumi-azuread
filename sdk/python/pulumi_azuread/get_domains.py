...
class GetDomainsResult:
    ...
    def __init__(__self__, domains=None, id=None, include_unverified=None, only_default=None, only_initial=None) -> None:
...
def get_domains(include_unverified: Optional[bool] = None, only_default: Optional[bool] = None, only_initial: Optional[bool] = None, opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsResult:
    """
